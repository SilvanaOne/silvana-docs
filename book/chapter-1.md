...
#### Counterparty risk
In many swap flows, 
- one party transfers an asset first, and 
- the counterparty is expected to complete their side afterward. 

This creates a window where one side is exposed. Even smart-contract swaps can fail due to partial execution, reverted transactions after one transfer, and off-chain coordination errors.

#### Escrow and custody assumptions
Typical swaps often rely on 
- escrow contracts,
- intermediaries, and 
- temporary custody of funds. 

This introduces trust assumptions, additional attack surfaces, and operational complexity.
