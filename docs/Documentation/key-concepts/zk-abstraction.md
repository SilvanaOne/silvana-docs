...
| **Settlement Abstraction**          | <ul><li>Query transaction status</li><li>Receive L1/L2 proof confirmation</li><li>No custom verifier contracts needed</li></ul> | <ul><li>Submits proof to on‑chain verifier contracts</li><li>Formats chain‑specific payload & calls</li><li>Updates on‑chain state commitments</li></ul> | <ul><li>Contract binding & payload formatting</li><li>Fee estimation & retry logic</li><li>Multi-chain verifier compatibility</li></ul> |
